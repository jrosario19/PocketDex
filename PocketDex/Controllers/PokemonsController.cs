...
namespace PocketDex.Controllers
{
    public class PokemonsController : Controller
    {
        ...
        {
            var pokeDexContext = _context.Pokemon.Include(p => p.Region);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Gender,Height,Weight,RegionId,PhotoPath")] Pokemon pokemon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Gender,Height,Weight,RegionId,PhotoPath")] Pokemon pokemon)
        {
            if (id != pokemon.Id)
            {
                return NotFound();
